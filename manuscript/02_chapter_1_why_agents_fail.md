...
graph LR
    ...
    style BUILT fill:#FBEAEA,stroke:#EB898B,stroke-width:1px,color:#121212, rx:18,ry:18
    style B1 fill:#F6D1CE,stroke:#EB898B,stroke-width:0.5px,color:#7A1F22,rx:10,ry:10
    style GAP fill:#e3dede,color:#121212,stroke:#30838C,stroke-width:1px,rx:18,ry:18
    style G1 fill:#999494 ,color:#ffffff,stroke:#30838C,stroke-width:0.5px,rx:10,ry:10
    style NEED fill:#E6F3F6,stroke:#32738C,stroke-width:1px,color:#121212,rx:18,ry:18
...
graph TB
    ...
    style timeline fill:#FBEAEA,stroke:#EB898B,stroke-width:1px,color:#121212,rx:18,ry:18
    ...
    style analysis fill:#d2f5fc,stroke:#32738C,stroke-width:1px,color:#121212,rx:18,ry:18
...
graph LR
    ...
    style sw1 fill:#FBEAEA,stroke:#EB898B,stroke-width:1px,color:#121212,rx:18,ry:18
    ...
    style sw2 fill:#E6F0FA,stroke:#32738C,stroke-width:1px,color:#121212,rx:18,ry:18
    ...
    style sw3 fill:#E6F3F6,stroke:#32738C,stroke-width:1px,color:#121212,rx:18,ry:18
...
graph TB
    ...
    style PROBLEM fill:#FBEAEA,stroke:#7A1F22,stroke-width:1px,color:#121212,rx:18,ry:18
    ...
    style SOLUTION fill:#E6F3F6,stroke:#00323D,stroke-width:1px,color:#121212,rx:18,ry:18
...
graph LR
    ...
    style BI fill:#FBEAEA,stroke:#EB898B,stroke-width:1px,color:#121212,rx:18,ry:18
    style AGENT fill:#E6F3F6,stroke:#32738C,stroke-width:1px,color:#121212,rx:18,ry:18
...
graph TB
    ...
    style investment fill:#ffffff,stroke:#32738C,stroke-width:1px,color:#121212,rx:18,ry:18
    style TOTAL fill:#ffffff,stroke:#32738C,stroke-width:0.5px,color:#00323D,rx:10,ry:10
    
    style pilots fill:#FBEAEA,stroke:#EB898B,stroke-width:1px,color:#121212,rx:18,ry:18
    ...
    style outcome fill:#FBEAEA,stroke:#EB898B,stroke-width:1px,color:#121212,rx:18,ry:18
